...
let {firstName} = nameTitle
let {lastName} = nameTitle
let {title} = nameTitle
...
let Cat1 = new Cat ('Juilian', 10, 'orange')
...
let fireWizard = new Wizard ('Blaze', 100, "FireBall")
...
class Phone {
  ...
  changePrice (newPrice) {
    this.price = newPrice
    console.log(this.price, 'New Price')
...
//Code Here
let Phone1 = new Phone ('iPhone', '13', 50, 'black', 1000)
let Phone2 = new Phone ('samsung', 'note',10 , 'white', 900)
let Phone3 = new Phone ('google', 'pixel', 20, 'black', 1100)
...
//Code Here
let myFirstVehicle = new Vehicle (4,'black', 12000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, 'grey', 1000, 'Harley')

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/
myFirstMotorcycle.move(999)
/*
...
//Code Here
let myFirstBoat = new Boat (10, 'red', 2000, "Nancy", "bigboat", false)
